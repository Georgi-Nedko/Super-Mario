...
//    }
    ...
    public MainMenuScreen(MarioBros g) {
       ...
       // this.stage = new Stage(viewport, this.batch);
        ...
        font = new BitmapFont(Gdx.files.internal("skin/font-export.fnt"), false); //** font **//ont **//
        style.font = font;
        ...
        //set height,width
        newGameButton.setHeight(stage.getViewport().getScreenHeight() / 15); //** Button Height **//
        newGameButton.setWidth(stage.getViewport().getScreenWidth() / 10); //** Button Width **//
        //set position
        newGameButton.setPosition(stage.getViewport().getWorldWidth() / 1.8f, stage.getViewport().getWorldHeight() / 1.8f);
        //set Listener
        ...
        mainMenu.setPosition(stage.getViewport().getWorldWidth()/1.91f,stage.getViewport().getWorldHeight()/1.3f);
        mainMenu.setFontScale(1.7f);

        loadGameButton = new TextButton("Load Game",style);
        loadGameButton.setColor(myColor);
        loadGameButton.setHeight(stage.getViewport().getScreenHeight() / 15); //** Button Height **//
        loadGameButton.setWidth(stage.getViewport().getScreenWidth() / 10); //** Button Width **//
        //set position
        loadGameButton.setPosition(stage.getViewport().getWorldWidth() / 1.8f, stage.getViewport().getWorldHeight() / 2.5f);
